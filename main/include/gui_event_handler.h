...
#define S_STOP_ACCESS_POINT BIT4
#define E_STOP_ACCESS_POINT BIT5

#define S_START_CONFIG_SERVER BIT6
#define E_START_CONFIG_SERVER BIT7

#define S_STOP_CONFIG_SERVER BIT8
#define E_STOP_CONFIG_SERVER BIT9
